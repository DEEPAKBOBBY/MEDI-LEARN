...
def signup():
    if request.method == 'POST':
        ...
        mydb4 = mysql.connector.connect(host="localhost", user="root", passwd="deepakbobby26229", database="medico")
        myc4 = mydb4.cursor()
...
def loginpage():
    if request.method=='POST':
        ...
        mydb = mysql.connector.connect(host="localhost", user="root", passwd="deepakbobby26229", database="medico")
        myc = mydb.cursor()
...
csv_file = "C:\\Users\\kalyan king\\PycharmProjects\\Medico project\\medicinedatasets\\Medicine_Details.csv"
    ...
    if request.method == 'POST':
        try:
            ...
            output = replicate.run(
                ...
                input={"prompt": model_prompt, "temperature": 0.1, "top_p": 0.9, "max_length": 500, "repetition_penalty": 1}
            )
...
def adwork():
    if request.method=='POST':
        ef = pd.read_csv("C:\\Users\\kalyan king\\PycharmProjects\\Medico project\\medicinedatasets\\Medicine_Details.csv")
        ...
        ef.to_csv("C:\\Users\\kalyan king\\PycharmProjects\\Medico project\\medicinedatasets\\Medicine_Details.csv",index=False)
